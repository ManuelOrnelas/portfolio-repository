  ...
  render() {
    ...
    return (
      <nav id="navbar">
        ...
        <Link className="flex-center" to="/sculpture" data-target="sculpture">
          <div id="sculpture" className={window.location.pathname==='/sculpture' ? 'square' : 'circle'}/>
        </Link>
        <Link className="flex-center" to="/graphics-design" data-target="graphics-design">
          <div id="graphics-design" className={window.location.pathname==='/graphics-design' ? 'square' : 'circle'}/>
        </Link>
        <Link className="flex-center" to="/product-design" data-target="product-design">
          <div id="product-design" className={window.location.pathname==='/product-design' ? 'square' : 'circle'}/>
        </Link>
        <Link className="flex-center" to="/drawing" data-target="drawing">
          <div id="drawing" className={window.location.pathname==='/drawing' ? 'square' : 'circle'}/>
        </Link>
        <Link className="flex-center" to="/writing" data-target="writing">
          <div id="writing" className={window.location.pathname==='/writing' ? 'square' : 'circle'}/>
        </Link>
        <Link className="flex-center" to="/interior-design" data-target="interior-design">
