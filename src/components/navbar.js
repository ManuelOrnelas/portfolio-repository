...
const Navbar = (props) => {
  ...
  <nav style={styles.nav}>
    <Link to="/" title="Logo" style={styles.logo}>
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2560 1440" style={styles.svg}>
        <title>NUCABE</title>
    ...
    <Link to='/sculpture'>
      <div className={window.location.pathname.includes('sculpture')
        ? styles.square
        : styles.circle
      }/>
    </Link>
